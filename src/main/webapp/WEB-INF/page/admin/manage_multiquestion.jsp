...
<div class="right col-md-10 f-r">
    ...
    <main>
        <table style="float:left;margin-bottom:2px;" >
            <td><button type="button" class="btn btn-info" data-toggle="modal" data-target="#myModal">添加选择题</button><span style="display:block;width:100px;"> </span></td>
            <td><button type="button" class="btn btn-info" onclick="OutputMultiExcel()">选择题信息导出</button><span style="display:block;width:130px;"> </span></td>
            <span> </span>
            <td>
                <input type="file" name="upload" style="border:0;text-align:center" id="upload_multi_question" value="选择题信息导入"/>
                <span style="display:block;width:100px;"> </span>
            </td>
            <td><button type="button" class="btn btn-info" onclick="uploadMultiFile()">选择题信息导入</button>
        </table>
